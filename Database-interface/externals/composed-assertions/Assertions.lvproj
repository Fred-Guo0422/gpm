...
<Project Type="Project" LVVersion="17008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Test" Type="Folder">
			<Item Name="StubVIs" Type="Folder">
				<Item Name="Assert 1D Array wired to 1D Array Type.vi" Type="VI" URL="../Test/StubVIs/Assert 1D Array wired to 1D Array Type.vi"/>
				<Item Name="Assert 1D Array wired to 2D Array Type.vi" Type="VI" URL="../Test/StubVIs/Assert 1D Array wired to 2D Array Type.vi"/>
				<Item Name="Assert 1D Array wired to Scalar Type.vi" Type="VI" URL="../Test/StubVIs/Assert 1D Array wired to Scalar Type.vi"/>
				<Item Name="Assert 2D Array wired to 1D Array Type.vi" Type="VI" URL="../Test/StubVIs/Assert 2D Array wired to 1D Array Type.vi"/>
				<Item Name="Assert 2D Array wired to 2D Array Type.vi" Type="VI" URL="../Test/StubVIs/Assert 2D Array wired to 2D Array Type.vi"/>
				<Item Name="Assert 2D Array wired to Scalar Type.vi" Type="VI" URL="../Test/StubVIs/Assert 2D Array wired to Scalar Type.vi"/>
				<Item Name="Assert 32 bit or less wired to 32 bit or less Type.vi" Type="VI" URL="../Test/StubVIs/Assert 32 bit or less wired to 32 bit or less Type.vi"/>
				<Item Name="Assert 32 bit or less wired to DBL Type.vi" Type="VI" URL="../Test/StubVIs/Assert 32 bit or less wired to DBL Type.vi"/>
				<Item Name="Assert 32 bit or less wired to I64 bit Type.vi" Type="VI" URL="../Test/StubVIs/Assert 32 bit or less wired to I64 bit Type.vi"/>
				<Item Name="Assert 32 bit or less wired to U64 bit Type.vi" Type="VI" URL="../Test/StubVIs/Assert 32 bit or less wired to U64 bit Type.vi"/>
				<Item Name="Assert 64 bit wired to 32 bit Type.vi" Type="VI" URL="../Test/StubVIs/Assert 64 bit wired to 32 bit Type.vi"/>
				<Item Name="Assert 64 bit wired to 64 bit Type.vi" Type="VI" URL="../Test/StubVIs/Assert 64 bit wired to 64 bit Type.vi"/>
				<Item Name="Assert Floating Point wired to Floating Point Type.vi" Type="VI" URL="../Test/StubVIs/Assert Floating Point wired to Floating Point Type.vi"/>
				<Item Name="Assert Floating Point wired to Int Type.vi" Type="VI" URL="../Test/StubVIs/Assert Floating Point wired to Int Type.vi"/>
				<Item Name="Assert Scalar wired to Array Type.vi" Type="VI" URL="../Test/StubVIs/Assert Scalar wired to Array Type.vi"/>
				<Item Name="Assert Scalar wired to Scalar Type.vi" Type="VI" URL="../Test/StubVIs/Assert Scalar wired to Scalar Type.vi"/>
			</Item>
			<Item Name="Test Assertions.lvclass" Type="LVClass" URL="../Test/Test Assertions/Test Assertions.lvclass"/>
		</Item>
		<Item Name="Assertions.lvlib" Type="Library" URL="../Source/Assertions.lvlib"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="VIAnUI Obtain CFG Password.vi" Type="VI" URL="/C/Program Files (x86)/National Instruments/LabVIEW 2017/project/_VI Analyzer/analyzerui.llb/VIAnUI Obtain CFG Password.vi"/>
		</Item>
